          ...
          <div className="flex flex-col mb-4">
            ...
            {gift_cards?.map((gc) => (
              ...
              >
                ...
                >
                  <Trash size={14} />
                  <span className="sr-only">إزالة بطاقة الخصم</span>
                </button>
              </div>
            ))}
          </div>
        ...
        {appliedDiscount ? (
          <div className="w-full flex items-center">
            <div className="flex flex-col w-full">
              <Heading className="txt-medium">الخصم المطبق</Heading>
              <div
          ...
          <form action={formAction} className="w-full">
            <Label className="flex gap-x-1 my-2 items-center">
              ...
              <Tooltip content="يمكنك استعمال عدة بطاقات هدية لكن كود خصم واحد.">
